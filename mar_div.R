...
# Here we rearrange dataframe by increasing of marriages
marriages_increasing <- marriages2017[order(marriages2017$`Браки на тысячу человек`, decreasing = F),]
marriages_increasing$`Разводы на тысячу человек` <- NULL
marriages_increasing$Разводы <- NULL

barplot(marriages_increasing[1:10,]$`Браки на тысячу человек`, las = 1, axes = T, names.arg = marriages_increasing[1:10,]$Место,
        col = c("green", "red", "blue", "yellow", "orange", "lightblue", "lavender", "cornsilk", "lavender", "lightcyan"), main ="Районы/города, в которых меньше всего вступают в брак, за 2017 год",
        ylab = "Браки на тысячу человек", horiz = F, cex.names = 0.6, cex.axis = 0.7, ylim= c(0,4))
...
# Here we rearrange dataframe by increasing of divorces
marriages_divorce_increasing <- marriages2017[order(marriages2017$`Разводы на тысячу человек`, decreasing = F),]
marriages_divorce_increasing$Браки  <- NULL
marriages_divorce_increasing$`Браки на тысячу человек`<- NULL


barplot(marriages_divorce_increasing[1:10,]$`Разводы на тысячу человек`, las = 1, axes = T, names.arg = marriages_divorce_increasing[1:10,]$Место,
        col = c("green", "red", "blue", "yellow", "orange", "lightblue", "lavender", "cornsilk", "lavender", "lightcyan"), main ="Районы/города, в которых меньше всего разводов за 2017 год",
        ylab = "Разводы на тысячу человек", horiz = F, cex.names = 0.7, cex.axis = 0.7, ylim= c(0,2))
